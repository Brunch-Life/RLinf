...
## 最新动态
- [2026/04] 🔥 RLinf 现已支持通过 [franky](https://github.com/TimSchneider42/franky) C++ RT 后端 + GELLO 实现无抖动 1 kHz 关节空间控制。文档：[Franka 关节空间控制：Franky + GELLO](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/franka_joint_gello.html)。
      ...
      <td>
        <ul style="margin-left: 0; padding-left: 16px;">
          ...
          <ul>
            ...
            <li><a href="https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/embodied/franka_joint_gello.html">Franky 关节控制</a> ✅</li>
          </ul>
